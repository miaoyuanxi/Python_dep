...
# This script may be invoked from a regular Python shell, not hython, so we
# need to add Houdini's script paths to sys.path before we can import hqlib
# (and the modules it depends on).
setupSysPath()
import hqlib

if __name__ == '__main__':
    hqlib.callFunctionWithHQParms(hqlib.stopSimulation)
