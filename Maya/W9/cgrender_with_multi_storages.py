...
class MayaRender(MayaClass):
    ...
    def render(self):
        ...
        if float(self["common"]["cgv"])==2017:
            ...
            # shutil.copy("//10.80.100.101/o5/py/model/2017updata3/mayaBatchRenderProcedure.mel", "C:/Program Files/Autodesk/Maya2017/scripts/others/mayaBatchRenderProcedure.mel")
            os.system ("robocopy /e /ns /nc /nfl /ndl /np  \"//10.80.100.101/o5/py/model/2017updata3\"  \"C:/Program Files/Autodesk/Maya2017/scripts/others\"" )
