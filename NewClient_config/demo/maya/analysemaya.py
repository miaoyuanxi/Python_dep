...
class Maya():
    def __init__(self,options):
        ...
        client_project_dir = client_project_dir.replace("\\", "/") + "/" + argument_json_dict['job_id_alias']
        ...
        analyze_script = os.path.join(os.path.abspath(sys.path[0] + '/../maya/Analyze/'), script_version)
    ...
    def analyse_cg_file(self):
        ...
        options = {}
        options["argument_json_path"] = self.argument_json_path
...
def analyse(param_dict):
    RBCommonUtil.debug_log('----------rayvision--submit----------analyse.maya--------------',param_dict['is_debug'])
    #pprint.pprint(param_dict)
    RBCommonUtil.debug_log(param_dict,param_dict['is_debug'])
